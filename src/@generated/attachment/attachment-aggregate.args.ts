...
import { AttachmentAvgAggregateInput } from './attachment-avg-aggregate.input';
import { AttachmentSumAggregateInput } from './attachment-sum-aggregate.input';
...
export class AttachmentAggregateArgs {
    ...
    @Field(() => AttachmentAvgAggregateInput, {nullable:true})
    _avg?: AttachmentAvgAggregateInput;

    @Field(() => AttachmentSumAggregateInput, {nullable:true})
    _sum?: AttachmentSumAggregateInput;
