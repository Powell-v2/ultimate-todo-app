...
import { TaskUpdateOneRequiredWithoutSubtasksInput } from '../task/task-update-one-required-without-subtasks.input';
...
export class SubtaskUpdateInput {
    ...
    @Field(() => TaskUpdateOneRequiredWithoutSubtasksInput, {nullable:true})
